...
class ShopSmsScreen extends ConsumerWidget {
      ...
      body: async.when(
        ...
        data: (list) {
          ...
          return RefreshIndicator(
            ...
            onRefresh: () async => ref.refresh(shopSmsLogProvider.future),
              ...
              itemBuilder: (context, i) {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(children: [
                        Expanded(child: Text(s.phone, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 14))),
                        Container(
                      ...
                      Text(s.message, style: const TextStyle(color: AppColors.textSecondary, fontSize: 13, height: 1.4)),
                      const SizedBox(height: 8),
                      Text(_df.format(s.createdAt.toLocal()), style: const TextStyle(color: AppColors.textMuted, fontSize: 11)),
                    ],
                  ),
