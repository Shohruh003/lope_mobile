  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const ShadSectionLabel("SALON"),
          const SizedBox(height: 8),
          ShadTileGroup(children: [
            ShadTile(icon: Icons.storefront_outlined, label: "Salon profili",
                onTap: () => context.push('/shop/profile')),
            ShadTile(icon: Icons.admin_panel_settings_outlined, label: "Adminlar",
                onTap: () => context.push('/shop/admins')),
            ShadTile(icon: Icons.alarm, label: "Eslatmalar",
