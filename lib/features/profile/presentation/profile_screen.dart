...
/// Theme mode row — mirrors the language tile pattern. Shows the
/// current mode on the right; tap opens a sheet with System / Light /
/// Dark. Persisted via [themeModeProvider].
            ...
            children: [
              ...
              Text(
                tr(ref, 'mobile.profile.themeHint',
                    "Ilova hozircha asosan qorong'i rejimga sozlangan — yorug' rejim to'liq qo'llab-quvvatlash tez orada tayyor bo'ladi."),
                style: AppText.caption,
              ),
              AppSpacing.gapMd,
